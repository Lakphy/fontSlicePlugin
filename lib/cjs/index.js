...
exports.FontSlicePlugin = void 0;
const path_1 = __importDefault(require("path"));
const fs_1 = __importDefault(require("fs"));
const webpack_1 = __importDefault(require("webpack"));
const fontSlicer_1 = require("./fontSlicer");
            ...
            compilation.hooks.processAssets.tapAsync({
                ...
                yield Promise.all(files.map((file) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (!fs_1.default.existsSync(path_1.default.join(assetsDirectory, `font/${file}`))) {
                        yield (0, fontSlicer_1.fontSlicer)(buffer, path_1.default.join(assetsDirectory, "font"), file, tempDirectory);
                    }
...
exports.FontSlicePlugin = FontSlicePlugin;
